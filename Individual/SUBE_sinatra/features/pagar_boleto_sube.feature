Feature: Pago de pasaje con tarjeta SUBE
    ...
    Given El pasajero con id 1 tiene 5$ en SUBE
    And El pasajero con id 1 posee tarifa social
    When El pasajero con id 1 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:00:00
    Then El boleto es emitido
    And El saldo de la sube con id 1 es -2.5$
    ...
    Given El pasajero con id 5 tiene -18$ en SUBE
    When El pasajero con id 5 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:00:00
    And El pasajero con id 5 paga el segundo boleto de 10$ en el transporte con id t1 con fecha 2018-09-16 15:15:00
    Then El boleto es emitido
    And El saldo de la sube con id 5 es -28$
    And El segundo boleto no puede ser emitido
    And El saldo final de la sube con id 5 es -28$
    ...
    When El pasajero con id 5 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-17 20:00:00
    And El pasajero con id 5 paga el segundo boleto de 10$ en el transporte con id t1 con fecha 2018-09-18 06:15:00
    Then El boleto es emitido
    ...
    Given El pasajero con id 3 tiene 50$ en SUBE
    When El pasajero con id 3 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:00:00
    And El pasajero con id 3 paga el segundo boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:10:00
    Then El boleto es emitido
    And El saldo de la sube con id 3 es 40$
    And El segundo boleto es emitido
    And El saldo final de la sube con id 3 es 30$
  ...
  Scenario: Pasajero con tarifa social tiene credito en la tarjeta SUBE para 1 boleto
    Given El pasajero con id 2 tiene -22$ en SUBE
    And El pasajero con id 2 posee tarifa social
    When El pasajero con id 2 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:00:00
    And El pasajero con id 2 paga el segundo boleto de 10$ en el transporte con id t1 con fecha 2018-09-16 15:15:00
    Then El boleto es emitido
    And El saldo de la sube con id 2 es -29.5$
    And El segundo boleto no puede ser emitido
    And El saldo final de la sube con id 2 es -29.5$
  ...
  Scenario: Pasajero con tarifa social tiene suficiente credito en la tarjeta SUBE para 2 boletos de distinto transporte fuera del lapso de 2 horas
    ...
    And El pasajero con id 1 posee tarifa social
    When El pasajero con id 1 paga el boleto de 10$ en el transporte con id c33 con fecha 2018-09-16 15:00:00
    And El pasajero con id 1 paga el segundo boleto de 10$ en el transporte con id t1 con fecha 2018-09-16 18:15:00
    Then El boleto es emitido
